...
public class FireAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fire_area);

        final ArrayList<Request> mListRequest = new ArrayList<>();

        mListView = findViewById(R.id.listRequest2);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(FireAreaActivity.this, RequestFireDetailedActivity.class);
        ...
        ChildEventListener childEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                if(request.type.equals("fire") && request.status == false){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            startActivity(new Intent(FireAreaActivity.this, MainActivity.class));
            finish();
        }
        else if(id == R.id.action_history){
            startActivity(new Intent(FireAreaActivity.this, HistoryRequestFireActivity.class));
            finish();
        }
